...
from hal.distributed import is_master
...
class DummyWriter:
    ...
    def plot_confusion_matrix(self, probs: Optional[Sequence[Sequence]] = None,
...
class Writer:
    def __init__(self, wandb_config: WandbConfig):
        ...
        if is_master():
            wandb.init(
                project=wandb_config.project, config=wandb_config.config, tags=wandb_config.tags,
    ...
    def plot_confusion_matrix(self, probs: Optional[Sequence[Sequence]] = None,
        ...
        return wandb.plot.confusion_matrix(probs=probs, y_true=y_true, preds=preds, class_names=class_names,
                                           title=title)
