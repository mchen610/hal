...
def local_session_cfg(
    ...
    *,
    ...
    This avoids the Linux AppImage fixture and ExI fast-forward path used by
    batch eval. On macOS it finds the Slippi Launcher netplay Dolphin by
    default; both paths remain overrideable for custom installs.
    """
    return SessionConfig(
